...
def button(request):
    button_name = request.data.get('name', None)
    button_value = request.data.get('value', None)
    callback_id = request.data.get('callback_id', None)
    print(button_name, button_value, callback_id)
